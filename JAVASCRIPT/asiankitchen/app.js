...
let addButtonDom = document.querySelector(".btn-container")
let addSectionDom = document.querySelector(".section-center")


const createButton = (btnName) => {
  // Create Button with btnName parameter & id 
...
function addButton(){
  addButtonDom.innerHTML = `${createButton("All")}${createButton("Korea")}${createButton("Japan")}${createButton("China")}` 
...
function allFoods(){
  ...
  addSectionDom.innerHTML = allMenu
}
